...
export async function getHolidays(token: string, year: number) {
...
export async function createHoliday(token: string, data: { date: string; name: string }) {
...
export async function resyncHolidays(token: string, year: number) {
